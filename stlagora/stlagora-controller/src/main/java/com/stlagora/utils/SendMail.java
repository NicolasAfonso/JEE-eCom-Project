...
public class SendMail {
	...
	public static void main(String[] args) {
		sendMessage("Envoi de mail marche :)", "Bonjour, Je suis STL-Agora, un super site cr�� par de supers �tudiant(e)s. En plus, je sais envoyer des mails tout seul comme un grand :)", "stl-agora@googlegroups.com", "afonso.nicolas@live.fr");
	}
}
